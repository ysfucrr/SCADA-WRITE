...
import RegisterNode from '@/components/flow/RegisterNode';
...
export default function BuildingPage({ params }: { params: Promise<{ building: string }> }) {
    ...
    const { building }: { building: string } = use(params)
    ...
    const getSelectedItemName = async () => {
        const navigationUrl = (await params).building;
